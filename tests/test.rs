...
export type Test8=({"type":"A";"value":{"a":string;"b":types.Usize;};}|{"type":"B";"value":{"A":types.Test4;"B":types.Test5;"C":types.Test6;"D":types.Test7;};}|{"type":"C";"value":types.Parent;}|{"type":"D";});
}
"#
        );
    }
    ...
    fn json() {
        assert_eq_str!(
            ...
            .unwrap(),
            r#"{"type":"B","value":{"A":[{"FOO_BAR":123,"a":"foo","b":null,"c":[true,false]},4,"bar"],"B":"cool-beans","C":{"B":[42,"baz"]},"D":null}}"#
        );
    }
