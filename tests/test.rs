...
export type Test1=(({"type":"A";}&{"a":types.Inner;})|(types.Inner&{"type":"B";})|{"type":"D";});
}
"#
        );
        assert_eq_str!(
...
export namespace types{
export type Inner={"x":boolean;};
export type Test2=({"type":"A";"value":{"a":types.Inner;};}|{"type":"B";"value":types.Inner;}|{"type":"D";});
}
"#);
        assert_eq_str!(
...
export namespace types{
export type Inner={"x":boolean;};
export type Test3=({"a":types.Inner;}|types.Inner|[types.Inner,types.Inner]|null);
}
"#
        );
        assert_eq_str!(
...
export namespace types{
export type Inner={"x":boolean;};
export type Test4=({"A":{"a":types.Inner;};}|{"B":types.Inner;}|{"C":[types.Inner,types.Inner];}|"D");
}
"#
        );
        assert_eq_str!(
